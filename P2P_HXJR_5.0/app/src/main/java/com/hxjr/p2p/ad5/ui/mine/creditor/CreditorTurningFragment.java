 ...
 * @date 2015年12月7日
 */
public class CreditorTurningFragment extends Fragment implements OnRefreshListener, OnMoreListener
{
	...
	private void initView()
	{
		...
		mListView.setEmptyText("您当前没有转让中的债权！");
	...
	private void initData()
	{
		if (adapter == null)
		{
			adapter = new CreditorTurningAdapter(context);
		}
					...
					if (DMConstant.ResultCode.SUCCESS.equals(code))
					{
						...
						if (!StringUtils.isEmpty(dataStr))
						{
							...
							for (int i = 0; i < dataList.length(); i++)
							{
								...
								MyCreditorAssignment mb = new MyCreditorAssignment(data);
								mList.add(mb);
							}
							if (number == 1)
							{
