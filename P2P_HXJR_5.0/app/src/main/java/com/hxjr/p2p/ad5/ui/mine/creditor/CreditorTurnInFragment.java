 ...
 * @date 2015年12月7日
 */
public class CreditorTurnInFragment extends Fragment implements OnRefreshListener, OnMoreListener
{
	...
	private void initView()
	{
		...
		mListView.setEmptyText("您当前没有已转入的债权！");
	...
	private void initData()
	{
		if (adapter == null)
		{
			adapter = new CreditorTurnInAdapter(context);
		}
