 ...
 * @date 2015年11月9日
 */
public class WeekFragment extends Fragment implements OnRefreshListener, OnMoreListener
{
	private View mView;
	...
	private static final String RANK_TYPE = "1";// 1-周排行，2-月排行，3-年排行
	...
	private void initView()
	{
		...
		mListView.setEmptyText(R.string.week_ranking_no_data);
