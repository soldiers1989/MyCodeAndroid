...
//        webSettings.setTextZoom(200);
        ...
        isGyb = getIntent().getBooleanExtra("isGyb", false);
        zqId = getIntent().getStringExtra("creditId");
    ...
    private void getCheckLoanContractData() {
        ...
        params.put("creditId", zqId);
        HttpUtil.getInstance().post(this, DMConstant.API_Url.CHECK_AGREEMENT, params, new HttpCallBack() {

            @Override
            public void onSuccess(JSONObject result) {
                try {
                    DMLog.e("getCheckLoanContractData", result.toString());
