...
import com.hxjr.p2p.ad5.utils.DisplayUtil;

/**
 * Created by TodayFu Lee on 2017/11/14.
 */
...
public class CameraTopRectView extends View {
    ...
    public CameraTopRectView(Context context, AttributeSet attrs) {
        ...
        // 相对于此view
        rectTop = (viewHeight - rectHeght) / 3;
        rectLeft = (viewWidth - rectWidth) / 2;
        rectBottom = rectTop *2+rectHeght/3;
        ...
        linePaint.setColor(Color.rgb(255, 251, 240));
    ...
    public void onDraw(Canvas canvas) {
        ...
        rect = new Rect(0, viewHeight / 3*2 - rectHeght / 3, viewWidth, viewHeight);
        canvas.drawRect(rect, wordPaint);

        rect = new Rect(0, 0, viewWidth, viewHeight / 3 - rectHeght / 3);
        canvas.drawRect(rect, wordPaint);

        rect = new Rect(0, viewHeight / 3 - rectHeght / 3, (viewWidth - rectWidth) / 2, viewHeight / 3 + rectHeght /
                3*2);
        canvas.drawRect(rect, wordPaint);

        rect = new Rect(viewWidth - (viewWidth - rectWidth) / 2, viewHeight / 3 - rectHeght / 3, viewWidth,
                viewHeight / 3 + rectHeght / 3*2);
        canvas.drawRect(rect, wordPaint);
        ...
        canvas.drawLine(rectLeft-10, rectTop, rectLeft + lineLen-10, rectTop,
                linePaint);
        canvas.drawLine(rectRight - lineLen+10, rectTop, rectRight+10, rectTop,
                linePaint);
        canvas.drawLine(rectLeft, rectTop, rectLeft, rectTop + lineLen,
                linePaint);
        canvas.drawLine(rectRight, rectTop, rectRight, rectTop + lineLen,
                linePaint);
        canvas.drawLine(rectLeft-10, rectBottom, rectLeft + lineLen-10, rectBottom,
                linePaint);
        canvas.drawLine(rectRight - lineLen+10, rectBottom, rectRight+10, rectBottom,
                linePaint);
