...
public class BidInfoFragment extends Fragment {
    ...
    public static BidInfoFragment getInstant(Bundle args) {
        if (instant == null) {
            instant = new BidInfoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.bid_base_info, container, false);
    }
    ...
    private void initView() {
        ...
        String url = DMConstant.Config.PLATA_URL + "bidItem.jsp?bidId=" + bidId;
