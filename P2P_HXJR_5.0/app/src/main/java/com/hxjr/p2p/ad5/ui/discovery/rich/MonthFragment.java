 ...
 * @date 2015年11月9日
 */
public class MonthFragment extends Fragment implements OnRefreshListener, OnMoreListener
{
	private View mView;
	...
	private static final String RANK_TYPE = "2";// 1-周排行，2-月排行，3-年排行
	...
	private void initView()
	{
		...
		mListView.setEmptyText(R.string.month_ranking_no_data);
