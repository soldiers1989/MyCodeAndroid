...
public class SharedPreferenceUtils
{
	 ...
	 * 保存在手机里面的文件名 
	 */
	public static final String REGEXINFO_FILE_NAME = "regexInfo";
	 ...
	 * 是否设置了手势密码
	 */
	public static final String KEY_HAS_LOCKED = "hasLocked";
	 ...
	 * 是否有新的版本
	 */
	public static final String KEY_HAVE_NEW_VERSION = "haveNewVersion";
