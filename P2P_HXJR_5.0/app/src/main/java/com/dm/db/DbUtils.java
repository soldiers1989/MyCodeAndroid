...
import com.dm.db.sqlite.CursorUtils;
import com.dm.db.sqlite.DbModelSelector;
import com.dm.db.sqlite.Selector;
import com.dm.db.sqlite.SqlInfo;
import com.dm.db.sqlite.SqlInfoBuilder;
import com.dm.db.sqlite.WhereBuilder;
import com.dm.db.table.DbModel;
import com.dm.db.table.Id;
import com.dm.db.table.Table;
import com.dm.db.table.TableUtils;
import com.dm.utils.DMLog;
import com.dm.utils.IOUtils;
...
public class DbUtils {
			...
			if (oldVersion != 0) {
				...
				if (upgradeListener != null) {
					...
					try {
						...
						DMLog.e("getInstance", e.getMessage());
					}
				}
			}
	...
	public static class DaoConfig {
		...
		private String dbName = "dm_data.db"; // default db name
