...
import com.dm.db.annotation.Table;
...
public class TableUtils {
	 ...
	 * key: entityType.name
	 */
	private static ConcurrentHashMap<String, com.dm.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.dm.db.table.Id>();

	/* package */
	static synchronized com.dm.db.table.Id getId(Class<?> entityType) {
		if (Object.class.equals(entityType)) {
		...
		com.dm.db.table.Id id = new com.dm.db.table.Id(entityType,
				primaryKeyField);
	...
	private static String getPrimaryKeyFieldName(Class<?> entityType) {
		com.dm.db.table.Id id = getId(entityType);
