 ...
 * @date 2016-4-7
 */
public class ScrollViewExperienceContainer extends RelativeLayout
{
		private static final int DEFAULT_PX_SPACE_HEIGHT = 163;
	...
	public ScrollViewExperienceContainer(Context context)
	{
		this(context, null);
	}
	
	public ScrollViewExperienceContainer(Context context, AttributeSet attrs)
	{
		this(context, attrs, 0);
	}
	
	public ScrollViewExperienceContainer(Context context, AttributeSet attrs, int defStyle)
	{
...
//		DMLog.e("mViewHeight + (int)mMoveLen", mViewHeight + (int)mMoveLen + "");
//		if (topView.getMeasuredHeight() + (int)mMoveLen == 0)
		// 判断bottomview到达顶部
