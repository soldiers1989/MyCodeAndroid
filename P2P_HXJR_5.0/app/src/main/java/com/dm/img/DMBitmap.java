...
import com.dm.img.bitmap.core.BitmapCache;
import com.dm.img.bitmap.core.BitmapDisplayConfig;
import com.dm.img.bitmap.core.BitmapProcess;
import com.dm.img.bitmap.display.Displayer;
import com.dm.img.bitmap.display.SimpleDisplayer;
import com.dm.img.bitmap.download.Downloader;
import com.dm.img.bitmap.download.SimpleDownloader;
import com.dm.img.core.AsyncTask;
 ...
 */
public class DMBitmap
{
    private DMBitmapConfig mConfig;
    ...
    private static DMBitmap mFinalBitmap;
    
    // //////////////////////// config method
    // start////////////////////////////////////
    private DMBitmap(Context context)
    {
        mContext = context;
        mConfig = new DMBitmapConfig(context);
        configDiskCachePath(Utils.getDiskCacheDir(context, "DMCache").getAbsolutePath());// 配置缓存路径
     ...
     * @return
     */
    public static synchronized DMBitmap create(Context ctx)
    {
        if (mFinalBitmap == null)
        {
            mFinalBitmap = new DMBitmap(ctx.getApplicationContext());
        }
        return mFinalBitmap;
    }
     ...
     * @param bitmap
     */
    public DMBitmap configLoadingImage(Bitmap bitmap)
    {
     ...
     * @param bitmap
     */
    public DMBitmap configLoadingImage(int resId)
    {
     ...
     * @param bitmap
     */
    public DMBitmap configLoadfailImage(Bitmap bitmap)
    {
     ...
     * @param resId
     */
    public DMBitmap configLoadfailImage(int resId)
    {
     ...
     * @param bitmapHeight
     */
    public DMBitmap configBitmapMaxHeight(int bitmapHeight)
    {
     ...
     * @param bitmapHeight
     */
    public DMBitmap configBitmapMaxWidth(int bitmapWidth)
    {
     ...
     * @return
     */
    public DMBitmap configDownlader(Downloader downlader)
    {
     ...
     * @return
     */
    public DMBitmap configDisplayer(Displayer displayer)
    {
     ...
     * @return
     */
    public DMBitmap configDiskCachePath(String strPath)
    {
     ...
     *            缓存大小
     */
    public DMBitmap configMemoryCacheSize(int size)
    {
     ...
     */
    public DMBitmap configMemoryCachePercent(float percent)
    {
     ...
     * @param size
     */
    public DMBitmap configDiskCacheSize(int size)
    {
     ...
     * @param size
     */
    public DMBitmap configBitmapLoadThreadSize(int size)
    {
        if (size >= 1)
     ...
     * @return
     */
    public DMBitmap configRecycleImmediately(boolean recycleImmediately)
    {
    ...
    /**
     * 执行过此方法后,DMBitmap的缓存已经失效,建议通过DMBitmap.create()获取新的实例
     * 
     * @author fantouch
     */
    ...
    /**
     * 关闭缓存 执行过此方法后,DMBitmap的缓存已经失效,建议通过DMBitmap.create()获取新的实例
     * 
     * @author fantouch
     */
    ...
    /**
     * @title 配置信息
     * @description DMBitmap的配置信息
     * @company 探索者网络工作室(www.tsz.net)
     * @author michael Young (www.YangFuhai.com)
     * @version 1.0
     * @created 2012-10-28
     */
    private class DMBitmapConfig
    {
        ...
        public DMBitmapConfig(Context context)
        {
